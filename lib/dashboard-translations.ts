...
export const dashboardTranslations = {
  en: {
    ...
    manageChannelModal: {
      ...
      adjustSearchOrInvite: "Adjust your search or invite new users",
    ...
    hospitalManagementPage: {
     ...
     createTaskModal: {
       ...
       priorities: {
        ...
        // Handoff Reports
        handoff: {
          sbarTitle: "SBAR Handoff Reports",
          description: "Structured communication reports for safe handoffs",
          newReport: "New Handoff Report",
          noReports: "No handoff reports yet",
          createFirst: "Create your first SBAR handoff report to ensure safe patient transitions.",
          ...
          backgroundPlaceholder: "What is the context and relevant history?",
          assessmentPlaceholder: "What do I think the problem is?",
          recommendationPlaceholder: "What should be done next?",
          modalTitle: "SBAR Handoff Report",
          modalDescription: "Create a structured handoff report using the SBAR format (Situation, Background, Assessment, Recommendation)",
          qrSection: "QR Code & Sharing",
          generateQR: "Generate QR",
          generating: "Generating...",
          shareInChat: "Share in Chat",
          exportPDF: "Export PDF",
          saveReport: "Save Handoff Report"
        },
    
        // Shift Handoff Reports
        shiftHandoff: {
          modalTitle: "Create {type} Shift Handoff Report",
          wardOverview: "Ward/Department Overview",
          situationsManaged: "Situations Managed",
          ...
          recentHandoffs: "Recent {type} Handoffs",
          shiftHandoffs: "Shift handover reports and ward status updates",
          createHandoffReport: "Create Handoff Report",
          noHandoffReports: "No handoff reports yet",
          createFirstHandoff: "Create the first {type} handoff report to get started.",
          wardDepartmentOverview: "Ward/Department Overview",
          whatEncountered: "What did you encounter during your shift? (Patient census, general ward status, etc.)",
          overviewPlaceholder: "e.g., Ward had 12 patients, 3 new admissions, 2 discharges planned...",
          situationsManagedDesc: "What situations did you handle? (Emergencies, interventions, consultations, etc.)",
          situationsPlaceholder: "e.g., Managed code blue in room 203, consulted with cardiology for patient in 205...",
          incidentsDesc: "What significant events or incidents occurred? (Falls, medication errors, equipment issues, etc.)",
          incidentsPlaceholder: "e.g., Patient fall in room 208 at 14:30, medication cart delay from pharmacy...",
          recommendationsDesc: "What should the next shift know or prioritize?",
          recommendationsPlaceholder: "e.g., Monitor patient in 201 closely, pending lab results for room 203, restock IV fluids...",
          additionalNotesDesc: "Any other information for the next shift?",
          additionalNotesPlaceholder: "e.g., Family meeting scheduled for tomorrow, pending discharge paperwork...",
          reportCreated: "Shift handoff report created successfully",
          failedToCreate: "Failed to create handoff report",
          errorCreating: "Failed to create handoff report",
          downloadQR: "Download QR",
          shareHandoff: "Share Handoff",
          failedToGenerateQR: "Failed to generate QR code",
          failedToDownloadQR: "Failed to download QR code",
          failedToShare: "Failed to share handoff report"
        },
  ...
  ar: {
    ...
    // Handoff Reports
    handoff: {
      sbarTitle: "تقارير تسليم SBAR",
      description: "تقارير اتصال منظمة للتسليمات الآمنة",
      newReport: "تقرير تسليم جديد",
      noReports: "لا توجد تقارير تسليم بعد",
      createFirst: "أنشئ تقرير تسليم SBAR الأول لضمان انتقالات المرضى الآمنة.",
      createFirstButton: "إنشاء التقرير الأول",
      situationLabel: "S - الوضع",
      backgroundLabel: "B - الخلفية",
      assessmentLabel: "A - التقييم",
      recommendationLabel: "R - التوصية",
      situationPlaceholder: "ما الذي يحدث الآن؟",
      backgroundPlaceholder: "ما هو السياق والتاريخ ذو الصلة؟",
      assessmentPlaceholder: "ما رأيي في المشكلة؟",
      recommendationPlaceholder: "ما الذي يجب فعله بعد ذلك؟",
      modalTitle: "تقرير تسليم SBAR",
      modalDescription: "أنشئ تقرير تسليم منظم باستخدام تنسيق SBAR (الوضع، الخلفية، التقييم، التوصية)",
      qrSection: "رمز QR والمشاركة",
      generateQR: "إنشاء رمز QR",
      generating: "جارٍ الإنشاء...",
      shareInChat: "مشاركة في الدردشة",
      exportPDF: "تصدير PDF",
      saveReport: "حفظ تقرير التسليم"
    },

    // Shift Handoff Reports
    shiftHandoff: {
      modalTitle: "إنشاء تقرير تسليم مناوبة {type}",
      wardOverview: "نظرة عامة على الجناح/القسم",
      situationsManaged: "المواقف التي تم التعامل معها",
      incidentsEvents: "الحوادث والأحداث",
      recommendations: "التوصيات للمناوبة التالية",
      additionalNotes: "ملاحظات إضافية",
      cancel: "إلغاء",
      creating: "جارٍ الإنشاء...",
      createReport: "إنشاء تقرير التسليم",
      recentHandoffs: "تقارير التسليم الأخيرة لـ {type}",
      shiftHandoffs: "تقارير تسليم المناوبات وتحديثات حالة الجناح",
      createHandoffReport: "إنشاء تقرير التسليم",
      noHandoffReports: "لا توجد تقارير تسليم بعد",
      createFirstHandoff: "أنشئ تقرير التسليم الأول لـ {type} للبدء.",
      wardDepartmentOverview: "نظرة عامة على الجناح/القسم",
      whatEncountered: "ما الذي واجهته خلال مناوباتك؟ (عدد المرضى، حالة الجناح العامة، إلخ)",
      overviewPlaceholder: "مثال: كان الجناح يحتوي على 12 مريضاً، 3 قبولات جديدة، 2 خروج مخطط...",
      situationsManagedDesc: "ما هي المواقف التي تعاملت معها؟ (الطوارئ، التدخلات، الاستشارات، إلخ)",
      situationsPlaceholder: "مثال: إدارة توقف قلب في الغرفة 203، استشارة مع القلب للمريض في 205...",
      incidentsDesc: "ما هي الأحداث أو الحوادث المهمة التي حدثت؟ (السقوط، أخطاء الأدوية، مشاكل المعدات، إلخ)",
      incidentsPlaceholder: "مثال: سقوط مريض في الغرفة 208 في الساعة 14:30، تأخير عربة الأدوية من الصيدلية...",
      recommendationsDesc: "ما الذي يجب أن تعرفه المناوبة التالية أو تعطيه الأولوية؟",
      recommendationsPlaceholder: "مثال: مراقبة المريض في 201 عن كثب، نتائج مختبر معلقة للغرفة 203، إعادة تخزين سوائل IV...",
      additionalNotesDesc: "أي معلومات أخرى للمناوبة التالية؟",
      additionalNotesPlaceholder: "مثال: اجتماع عائلي مجدول للغد، أوراق خروج معلقة...",
      reportCreated: "تم إنشاء تقرير تسليم المناوبة بنجاح",
      failedToCreate: "فشل في إنشاء تقرير التسليم",
      errorCreating: "فشل في إنشاء تقرير التسليم",
      downloadQR: "تحميل QR",
      shareHandoff: "مشاركة التسليم",
      failedToGenerateQR: "فشل في إنشاء رمز QR",
      failedToDownloadQR: "فشل في تحميل رمز QR",
      failedToShare: "فشل في مشاركة تقرير التسليم"
    },
    ...
    manageChannelModal: {
      ...
      adjustSearchOrInvite: "قم بتعديل بحثك أو دعوة مستخدمين جدد",
