...
var ChatRoom = class {
  ...
  async handleSession(webSocket) {
    ...
    webSocket.addEventListener("error", (error3) => {
  ...
  broadcast(message) {
    ...
    this.sessions.forEach((session) => {
      try {
        ...
        console.error("Failed to send message to a session:", error3);
...
var worker_default = {
  async fetch(request, env2) {
    ...
    let id = env2.CHAT_ROOM.idFromName(room);
    let stub = env2.CHAT_ROOM.get(id);
...
// .wrangler/tmp/bundle-cbflRF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-cbflRF/middleware-loader.entry.ts
