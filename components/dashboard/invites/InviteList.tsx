      ...
      <div className="bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-950/50 dark:to-primary-900/30 border-b border-border px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            className="bg-primary-600 hover:bg-primary-700 text-primary-foreground shadow-sm transition-all duration-200 hover:shadow-md"
          >
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <Button
              onClick={() => setIsModalOpen(true)}
              variant="outline"
              className="border-primary-200 text-primary-600 hover:bg-primary-50 dark:border-primary-800 dark:text-primary-400 dark:hover:bg-primary-950/30"
            >
              <Plus className="w-4 h-4 mr-2" />
              Send First Invite
            </Button>
