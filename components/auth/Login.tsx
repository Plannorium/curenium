      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-dark-800/50 backdrop-blur-lg border border-dark-700 rounded-2xl shadow-2xl shadow-black/20 p-8">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <Button variant="outline" onClick={() => signIn('google')} className="bg-dark-700/50 border-dark-600 hover:bg-dark-600/50">
            ...
            <Button variant="outline" onClick={() => signIn('github')} className="bg-dark-700/50 border-dark-600 hover:bg-dark-600/50">
              <svg width="20" height="20" className="mr-2" viewBox="0 0 24 24" fill="currentColor">
