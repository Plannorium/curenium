  ...
  return (
    <div className="relative min-h-screen bg-background">
      ...
      <div className="relative p-4 sm:p-6 md:p-8">
        {/* Header Section */}
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between backdrop-blur-sm bg-card/30 rounded-2xl p-6 border border-border/50 shadow-lg">
          <div className="space-y-2 text-center sm:text-left">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-1">
              <span className="block sm:inline bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent">{welcomeMessage}, </span>
          ...
          <Button className="mt-4 sm:mt-0 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] backdrop-blur-sm border border-primary/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {/* Current Shift Card */}
          <Card className="group relative overflow-hidden backdrop-blur-lg bg-gradient-to-br from-primary/90 to-primary border-primary/30 text-primary-foreground shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
            <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent pointer-events-none"></div>
            <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-primary-foreground/90">Current Shift</CardTitle>
              <div className="p-2 bg-white/20 rounded-lg backdrop-blur-sm">
                <CalendarIcon className="h-4 w-4 text-primary-foreground" />
              </div>
            </CardHeader>
            <CardContent className="relative">
              <div className="text-2xl md:text-3xl font-bold text-primary-foreground mb-1">08:00 - 17:00</div>
              <p className="text-sm text-primary-foreground/80 font-medium">4 hours remaining</p>
            </CardContent>
          </Card>

          {/* Active Alerts Card */}
          <Card className="group relative overflow-hidden backdrop-blur-lg bg-card/80 border-border/50 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
            <div className="absolute inset-0 bg-gradient-to-br from-red-500/5 to-transparent pointer-events-none"></div>
            <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-foreground">Active Alerts</CardTitle>
            ...
            <CardContent className="relative">
              ...
              <p className="text-sm text-muted-foreground font-medium">+3 Urgent</p>
            </CardContent>
          </Card>
          ...
          <Card className="group relative overflow-hidden backdrop-blur-lg bg-card/80 border-border/50 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
            ...
            <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-foreground">Pending Tasks</CardTitle>
          ...
          <Card className="group relative overflow-hidden backdrop-blur-lg bg-card/80 border-border/50 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
            ...
            <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-foreground">Active Staff</CardTitle>
            ...
            <CardContent className="relative">
              <div className="text-2xl md:text-3xl font-bold text-foreground mb-1">12 / 15</div>
              <p className="text-sm text-muted-foreground font-medium">Cardiology Department</p>
            </CardContent>
          </Card>
        </div>
