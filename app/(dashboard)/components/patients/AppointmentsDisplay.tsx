            ...
            >
              ...
              >
                ...
                <span className="text-sm sm:text-base">
                  {t("appointmentsDisplay.bookAppointment")}
                </span>
              </Button>
            </BookAppointmentModal>
          )}
              ...
              <TableHeader>
                <TableRow className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 border-b border-gray-200 dark:border-gray-700">
                  <TableHead className="font-semibold text-gray-900 dark:text-gray-100">
                    {t("appointmentsDisplay.date")}
                  </TableHead>
                  <TableHead className="font-semibold text-gray-900 dark:text-gray-100">
                    {t("appointmentsDisplay.reason")}
                  </TableHead>
                  <TableHead className="font-semibold text-gray-900 dark:text-gray-100">
                    {t("appointmentsDisplay.status")}
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {appointments.map((a, index) => (
                  <TableRow
                    ...
                    className={`hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors duration-200 ${
                      index % 2 === 0
                        ? "bg-white/30 dark:bg-gray-900/10"
              ...
              ["admin", "receptionist"].includes(session.user.role) && (
                ...
                >
                  ...
                  >
                    <CalendarPlus className="mr-2 h-3 w-3 sm:h-4 sm:w-4" />
                    <span className="text-sm sm:text-base">
                      {t("appointmentsDisplay.scheduleFirstAppointment")}
                    </span>
                  </Button>
                </BookAppointmentModal>
              )}
